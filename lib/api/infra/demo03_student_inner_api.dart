...
/// 学生 API - Demo03 Inner模式 (主子表)
class Demo03StudentInnerApi {
  final ApiClient _client;

  Demo03StudentInnerApi(this._client);
...
/// Demo03StudentInnerApi 提供者
final demo03StudentInnerApiProvider = Provider<Demo03StudentInnerApi>((ref) {
  return Demo03StudentInnerApi(ref.watch(apiClientProvider));
});